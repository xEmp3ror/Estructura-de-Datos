...
class Vector3D
{
  //! \name Atributos privados de la clase Vector3D
	...
	*/
	...
	inline double get1() const { return vector[0]; };
	...
	*/
	...
	inline double get2() const { return vector[1]; };
	...
	*/
	...
	inline double get3() const { return vector[2]; };
	...
	*/
	...
	inline void   set1(double v1) { vector[0] = v1; };
	...
	*/
	...
	inline void   set2(double v2) { vector[1] = v2; };
	...
	*/
	...
	inline void   set3(double v3) { vector[2] = v3; };
